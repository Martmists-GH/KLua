...
do
    ...
    do
        ...
        local o1 = setmetatable({}, { __close = function()
            closed = true
        end })
    ...
    if rawget(_G, "T") then
        ...
        do
            ...
            local o = setmetatable({}, { __close = function()
                loop(0)
            end })
        ...
        do
            -- testing 'toclose' in C string buffer
            collectgarbage()
        ...
        do
            -- now some tests for freeing buffer in case of errors
